---
title: "Project 2: Spatial and Temporal Interactive App of Cat Movement"
subtitle: "Proposal"
...
-   `/data/*`: Data folder
    ...
    -   `/data/README.md`: Metadata about the datasets (to be edited after data wrangling)

-   `index.qmd`: The project write-up (to be completed)

-   `proposal.qmd`: The project proposal (to be revised after peer feedback)

-   `presentation.qmd`: The project presentation (to be completed)
